...
class Guest(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        if request.method in SAFE_METHODS or request.user and request.user.ST1011_Permission.guest:
            return True
        return False
...
class Registrar(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        if request.method in EXPANDED_METHODS or request.user and request.user.ST1011_Permission.registrar:
            return True
        return False
...
class Consultant(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        if request.method in SAFE_METHODS or request.user and request.user.ST1011_Permission.consultant:
            return True
        return False
...
class Clinician(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return bool(request.user and request.user.ST1011_Permission.clinician)
...
class Pathologist(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return bool(request.user and request.user.ST1011_Permission.pathologist)
