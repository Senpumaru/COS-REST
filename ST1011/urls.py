...
urlpatterns = [
    ...
    path("cases/<str:uuid>/decline/", CaseDecline.as_view(), name="Case-Decline"),
    ...
    path("cases/<str:personal_number>/archive/", CaseArchiveList.as_view(), name="Case-Archive"),
    path("cases/<str:uuid>/pdf/", case_pdf_report, name="Case-Update"),
    path("cases/<str:personal_number>/delivery/", caseDelivery.as_view(), name="Case-Delivery"),
