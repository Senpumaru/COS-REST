    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution_code', models.PositiveIntegerField(blank=True, choices=[(0, 0), (328112, 328112), (328044, 328044), (328043, 328043), (328045, 328045), (327933, 327933), (327932, 327932)], null=True, verbose_name='Institution code')),
                ...
                ('diagnosis', models.CharField(blank=True, max_length=200, null=True, verbose_name='Diagnosis')),
                ...
                ('case_assistant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ST1010_case_assistant', to=settings.AUTH_USER_MODEL)),
                ('case_consultants', models.ManyToManyField(blank=True, default=[], related_name='CaseConsultantsST1010', to=settings.AUTH_USER_MODEL)),
                ('case_creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ST1010_case_creator', to=settings.AUTH_USER_MODEL)),
                ('case_editor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CaseEditorST1010', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_delivery', models.DateField(blank=True, default=datetime.date.today, null=True)),
                ('case', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ST1010_case_delivery', to='ST1010.case')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateField(blank=True, default=datetime.date.today, null=True, verbose_name='Date Created')),
                ('date_updated', models.DateField(auto_now=True, null=True, verbose_name='Date Updated')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ST1010_comment_author', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateField(blank=True, default=datetime.date.today, null=True, verbose_name='Date created')),
                ('date_updated', models.DateField(auto_now=True, null=True, verbose_name='Date updated')),
                ('case', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ST1010_case_approvals', to='ST1010.case')),
                ('consultant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ST1010_case_consultants', to=settings.AUTH_USER_MODEL)),
            ],
            options={
