...
class Case(models.Model):
    ...
    case_creator = models.ForeignKey(
        ...
        related_name="ST1010_case_creator",
        null=True,
        blank=False,
    )
    case_assistant = models.ForeignKey(
        to=ServiceUser,
        on_delete=models.SET_NULL,
        related_name="ST1010_case_assistant",
        null=True,
        blank=True,
    )
    ...
    def institution(self):
        INSTITUTION_CODES = {
            ...
            328045: "УЗ «Гродненская университетская клиника»",
...
class Delivery(models.Model):
    case = models.ForeignKey(
        to="Case",
        related_name="ST1010_case_delivery",
        on_delete=models.CASCADE,
        null=True,
        blank=False,
    )
...
class Approval(models.Model):
    case = models.ForeignKey(
        to="Case",
        related_name="ST1010_case_approvals",
        on_delete=models.CASCADE,
        null=True,
        blank=False,
    )
    consultant = models.ForeignKey(
        to=ServiceUser,
        related_name="ST1010_case_consultants",
        on_delete=models.CASCADE,
        null=True,
        blank=False,
    )
...
class Comment(models.Model):
    ...
    author = models.ForeignKey(
        to=ServiceUser,
        on_delete=models.CASCADE,
        related_name="ST1010_comment_author",
    )
