...
class CaseCreateSerializer(serializers.ModelSerializer):
    ...
    block_codes = serializers.ListSerializer(required=False, child=serializers.CharField(allow_blank=True))
    slide_codes = serializers.ListSerializer(required=False, child=serializers.CharField(allow_blank=True))
...
class CaseDetailsSerializer(serializers.ModelSerializer):
    ...
    case_approvals = CaseApprovalUpdateSerializer(source="ST1010_case_approvals", read_only=True, many=True)
...
class CaseListSerializer(serializers.ModelSerializer):
    ...
    case_deliveries = DeliverySerializer(source="ST1010_case_delivery", read_only=True, many=True)
